...
public class SysUserServiceImpl extends ServiceImpl<SysUserMapper, SysUser> implements SysUserService {
     ...
     */
    @Override
    public PageVO<SysUserVO> listSysUser(SysUserListParam sysUserListParam) {
        String sysUserId = sysUserListParam.getUserId();
        Page<SysUser> page = page(new Page<>(sysUserListParam.getPageNo(), sysUserListParam.getPageSize()),
